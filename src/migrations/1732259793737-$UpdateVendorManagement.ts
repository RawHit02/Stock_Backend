...
export class  $UpdateVendorManagement1732259793737 implements MigrationInterface {
    name = ' $UpdateVendorManagement1732259793737'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "StockManagementTbl" ("Id" uuid NOT NULL DEFAULT uuid_generate_v4(), "CreatedBy" character varying(150) NOT NULL, "CreatedDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "UpdatedBy" character varying(150), "UpdatedDate" TIMESTAMP WITH TIME ZONE DEFAULT now(), "IsDeleted" boolean NOT NULL DEFAULT false, "StockType" "public"."StockManagementTbl_stocktype_enum" NOT NULL DEFAULT 'inward', "TransId" character varying NOT NULL, "Description" text NOT NULL, "Quantity" character varying(50) NOT NULL, "UnitPrice" character varying(20) NOT NULL, "Commission" numeric(20,2) NOT NULL DEFAULT '0', "TotalValue" numeric(20,2) NOT NULL DEFAULT '0', "BatchNumber" character varying(50) NOT NULL, "Location" character varying(100) NOT NULL, "Notes" text DEFAULT 'N/A', "VendorId" uuid NOT NULL, CONSTRAINT "UQ_602abff21b7105c5ae03f072e2f" UNIQUE ("TransId"), CONSTRAINT "PK_75d1c30e1f5f324d4717e031d33" PRIMARY KEY ("Id"))`);
